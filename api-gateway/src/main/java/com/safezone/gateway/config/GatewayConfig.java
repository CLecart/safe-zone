 ...
 *
 * <p>Defines routing rules to forward requests to appropriate microservices. Uses Spring Cloud
 * Gateway's load balancing capabilities.
 *
...
public class GatewayConfig {
     ...
     *
     * <ul>
     *   <li>/api/v1/products/** → product-service
     *   <li>/api/v1/orders/** → order-service
     *   <li>/api/v1/auth/** → user-service
     *   <li>/api/v1/users/** → user-service
     * </ul>
     *
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route("user-service-auth", r -> r.path("/api/v1/auth/**").uri("lb://user-service"))
