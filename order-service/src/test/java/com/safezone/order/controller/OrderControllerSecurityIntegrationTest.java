...
class OrderControllerSecurityIntegrationTest {
    @org.mockito.Mock private com.safezone.order.client.ProductServiceClient productServiceClient;
    @Autowired private com.safezone.order.repository.OrderRepository orderRepository;
    ...
    void setupTestOrder() {
        ...
        org.mockito.Mockito.when(productServiceClient.getProductById(org.mockito.Mockito.anyLong()))
                .thenReturn(
                        java.util.Optional.of(
                                new com.safezone.order.dto.ProductDto(
                                        1L,
                                        "Produit Test",
                                        "SKU-TEST-001",
        ...
        org.mockito.Mockito.when(
                        productServiceClient.checkProductAvailability(
                                org.mockito.Mockito.anyLong(), org.mockito.Mockito.anyInt()))
                .thenReturn(true);
        ...
        com.safezone.order.entity.Order order =
                com.safezone.order.entity.Order.builder()
        ...
        com.safezone.order.entity.OrderItem item =
                com.safezone.order.entity.OrderItem.builder()
                        .productId(1L)
    ...
    void getOrderById_publicAccess() throws Exception {
        mockMvc.perform(get("/api/v1/orders/" + testOrderId)).andExpect(status().isOk());
    }
