...
/**
 * Integration tests for {@link OrderController}. Tests all REST endpoints for order management with
...
class OrderControllerTest {
    ...
    class GetOrderTests {
        ...
        void shouldGetOrdersByUserId() throws Exception {
            ...
            mockMvc.perform(get("/api/v1/orders/user/1").param("page", "0").param("size", "20"))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.success").value(true))
    ...
    class GetAllOrdersTests {
        ...
        void shouldGetAllOrdersWithDescSort() throws Exception {
            ...
            mockMvc.perform(get("/api/v1/orders").param("sortDir", "desc"))
                    .andExpect(status().isOk());
        }
        ...
        void shouldGetAllOrdersWithAscSort() throws Exception {
            ...
            mockMvc.perform(get("/api/v1/orders").param("sortDir", "asc"))
                    .andExpect(status().isOk());
        }
    ...
    class UpdateOrderStatusTests {
        ...
        void shouldUpdateOrderStatus() throws Exception {
            ...
            given(orderService.updateOrderStatus(1L, OrderStatus.CONFIRMED)).willReturn(updated);
