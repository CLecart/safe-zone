...
/**
 * Comprehensive test suite for {@link Order} and {@link OrderItem} entity builder patterns.
 *
 * <p><strong>Purpose:</strong> Tests Lombok-generated builders for Order and OrderItem entities to
 * achieve 100% code coverage. Builder pattern enables flexible object construction with optional
 * fields.
 *
 * <p><strong>Coverage Strategy:</strong>
 *
 * <ul>
 *   <li>Test builders with all fields populated
 *   <li>Test builders with minimal required fields
 *   <li>Test builders with partial field combinations
 *   <li>Test default values (@Builder.Default)
 *   <li>Test lifecycle callbacks (@PrePersist, @PreUpdate)
 *   <li>Test business methods (addItem, removeItem, calculateTotalAmount, calculateSubtotal)
 * </ul>
 *
 * <p><strong>Target:</strong> Achieve 100% instruction and branch coverage for OrderBuilder and
 * OrderItemBuilder.
 *
...
class OrderBuilderTest {
    ...
    /**
     * Nested test class for Order entity builder pattern. Tests comprehensive coverage of
     * Order.OrderBuilder.
     */
    @Nested
    ...
    class OrderBuilderTests {
         ...
         *
         * <p><strong>Scenario:</strong> Construct Order entity with complete data.
         *
         * <p><strong>Given:</strong> All Order fields have values.
         *
         * <p><strong>When:</strong> Builder builds Order instance.
         *
         * <p><strong>Then:</strong> Order contains all specified field values.
         *
         * <p><strong>Coverage:</strong> Tests all Order builder setter methods.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Construct Order with only mandatory fields.
         *
         * <p><strong>Given:</strong> Only orderNumber, userId, totalAmount.
         *
         * <p><strong>When:</strong> Builder builds Order.
         *
         * <p><strong>Then:</strong> Order has required fields, optionals are null/default.
         *
         * <p><strong>Coverage:</strong> Tests builder with minimal fields.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Order with different shipping/billing addresses.
         *
         * <p><strong>Given:</strong> Shipping and billing addresses provided.
         *
         * <p><strong>When:</strong> Builder builds Order.
         *
         * <p><strong>Then:</strong> Order has specified addresses.
         *
         * <p><strong>Coverage:</strong> Tests address builder methods.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Build orders in different lifecycle states.
         *
         * <p><strong>Given:</strong> Various OrderStatus values.
         *
         * <p><strong>When:</strong> Builder builds Orders with each status.
         *
         * <p><strong>Then:</strong> Orders have correct status values.
         *
         * <p><strong>Coverage:</strong> Tests status builder method with all enum values.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> JPA callback sets default values before insert.
         *
         * <p><strong>Given:</strong> Order built without status/timestamps.
         *
         * <p><strong>When:</strong> onCreate() is called (simulates JPA).
         *
         * <p><strong>Then:</strong> Default status=PENDING and timestamps are set.
         *
         * <p><strong>Coverage:</strong> Tests onCreate() lifecycle method.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> JPA callback respects explicitly set status.
         *
         * <p><strong>Given:</strong> Order built with status=CONFIRMED.
         *
         * <p><strong>When:</strong> onCreate() is called (simulates JPA).
         *
         * <p><strong>Then:</strong> Default status is NOT applied, existing status preserved.
         *
         * <p><strong>Coverage:</strong> Tests onCreate() when status is not null (else branch).
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> JPA callback refreshes timestamp before update.
         *
         * <p><strong>Given:</strong> Order with old updatedAt timestamp.
         *
         * <p><strong>When:</strong> onUpdate() is called (simulates JPA).
         *
         * <p><strong>Then:</strong> UpdatedAt is refreshed to current time.
         *
         * <p><strong>Coverage:</strong> Tests onUpdate() lifecycle method.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Add OrderItem to Order with bidirectional link.
         *
         * <p><strong>Given:</strong> Order and OrderItem exist.
         *
         * <p><strong>When:</strong> addItem() is called.
         *
         * <p><strong>Then:</strong> Item is added to order and item.order is set.
         *
         * <p><strong>Coverage:</strong> Tests addItem() method.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Remove OrderItem from Order and clear relationship.
         *
         * <p><strong>Given:</strong> Order contains OrderItem.
         *
         * <p><strong>When:</strong> removeItem() is called.
         *
         * <p><strong>Then:</strong> Item removed from order and item.order is null.
         *
         * <p><strong>Coverage:</strong> Tests removeItem() method.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Calculate order total from all items.
         *
         * <p><strong>Given:</strong> Order contains multiple items with subtotals.
         *
         * <p><strong>When:</strong> calculateTotalAmount() is called.
         *
         * <p><strong>Then:</strong> Total equals sum of all item subtotals.
         *
         * <p><strong>Coverage:</strong> Tests calculateTotalAmount() method.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Calculate total when order has no items.
         *
         * <p><strong>Given:</strong> Order with empty items list.
         *
         * <p><strong>When:</strong> calculateTotalAmount() is called.
         *
         * <p><strong>Then:</strong> Total equals zero.
         *
         * <p><strong>Coverage:</strong> Tests edge case of empty items.
         */
        @Test
    ...
    /**
     * Nested test class for OrderItem entity builder pattern. Tests comprehensive coverage of
    ...
    class OrderItemBuilderTests {
         ...
         *
         * <p><strong>Scenario:</strong> Construct OrderItem with complete data.
         *
         * <p><strong>Given:</strong> All OrderItem fields have values.
         *
         * <p><strong>When:</strong> Builder builds OrderItem.
         *
         * <p><strong>Then:</strong> OrderItem contains all field values.
         *
         * <p><strong>Coverage:</strong> Tests all OrderItem builder setters.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Construct OrderItem with required fields only.
         *
         * <p><strong>Given:</strong> Only productId, productName, productSku, quantity, unitPrice.
         *
         * <p><strong>When:</strong> Builder builds OrderItem.
         *
         * <p><strong>Then:</strong> OrderItem has required fields, optionals null.
         *
         * <p><strong>Coverage:</strong> Tests minimal builder usage.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Calculate subtotal from quantity × unitPrice.
         *
         * <p><strong>Given:</strong> OrderItem with quantity=3, unitPrice=15.50.
         *
         * <p><strong>When:</strong> calculateSubtotal() is called.
         *
         * <p><strong>Then:</strong> Subtotal equals 46.50 (3 × 15.50).
         *
         * <p><strong>Coverage:</strong> Tests calculateSubtotal() method.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Calculate subtotal for single item.
         *
         * <p><strong>Given:</strong> Quantity=1, unitPrice=25.00.
         *
         * <p><strong>When:</strong> calculateSubtotal() is called.
         *
         * <p><strong>Then:</strong> Subtotal equals unitPrice (25.00).
         *
         * <p><strong>Coverage:</strong> Tests edge case of quantity=1.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Calculate subtotal for bulk order.
         *
         * <p><strong>Given:</strong> Quantity=100, unitPrice=2.50.
         *
         * <p><strong>When:</strong> calculateSubtotal() is called.
         *
         * <p><strong>Then:</strong> Subtotal equals 250.00 (100 × 2.50).
         *
         * <p><strong>Coverage:</strong> Tests calculation with larger numbers.
         */
        @Test
         ...
         *
         * <p><strong>Scenario:</strong> Build item with precise decimal pricing.
         *
         * <p><strong>Given:</strong> UnitPrice=12.345 (3 decimal places).
         *
         * <p><strong>When:</strong> Builder builds OrderItem.
         *
         * <p><strong>Then:</strong> Price precision is maintained.
         *
         * <p><strong>Coverage:</strong> Tests decimal precision handling.
         */
        @Test
