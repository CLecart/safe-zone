...
/**
 * Coverage tests for {@link Order} entity. Focuses on builder variations, all getter/setter
 * combinations, and calculateTotalAmount().
 *
...
class OrderCoverageTest {
    ...
    void builderCreatesOrder() {
        assertThat(testOrder)
                ...
                .containsExactly(
                        1L, "ORD-20260106-ABC12345", 1L, OrderStatus.PENDING, "123 Test St");
