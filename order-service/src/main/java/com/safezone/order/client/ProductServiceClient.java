 ...
 *
 * <p>Provides methods to retrieve product information, check availability, and update stock levels
...
public class ProductServiceClient {
    ...
    public ProductServiceClient(
        ...
        this.webClient =
                webClientBuilder.baseUrl(Objects.requireNonNull(productServiceUrl)).build();
    }
