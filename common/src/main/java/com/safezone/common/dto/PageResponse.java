...
/**
 * Generic paginated response wrapper for list endpoints. Provides pagination metadata alongside the
 * content.
 *
...
public record PageResponse<T>(
        ...
        boolean last) {
    /**
     * Creates a PageResponse from content and pagination parameters. Automatically calculates
     * totalPages, first, and last flags.
     *
