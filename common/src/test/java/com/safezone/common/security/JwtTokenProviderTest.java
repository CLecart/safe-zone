...
/**
 * Unit tests for {@link JwtTokenProvider}. Verifies token generation, validation, and claim
...
class JwtTokenProviderTest {
    ...
    private static final String SECRET =
            "dGVzdC1zZWNyZXQta2V5LWZvci1zYWZlem9uZS1hcHBsaWNhdGlvbi10ZXN0aW5nLW9ubHktdGhpcy1pcy1sb25nLWVub3VnaA==";
    ...
    class TokenGenerationTests {
        ...
        void shouldGenerateTokenWithMultipleRoles() {
            String token =
                    jwtTokenProvider.generateToken("admin", List.of("ROLE_USER", "ROLE_ADMIN"));
    ...
    class TokenValidationTests {
        ...
        void shouldRejectTokenWithInvalidSignature() {
            JwtTokenProvider otherProvider =
                    new JwtTokenProvider("another-secret-for-tests-should-differ", EXPIRATION);
    ...
    class TokenExtractionTests {
        ...
        void shouldExtractRolesFromToken() {
            String token =
                    jwtTokenProvider.generateToken("testuser", List.of("ROLE_USER", "ROLE_ADMIN"));
