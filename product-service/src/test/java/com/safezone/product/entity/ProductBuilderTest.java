 ...
 *
 * <p><strong>Purpose:</strong> Tests the Lombok-generated builder for Product entity to achieve
 * 100% code coverage. Builder pattern enables flexible object construction with optional fields.
 *
 * <p><strong>Coverage Strategy:</strong>
 *
 * <ul>
 *   <li>Test builder with all fields populated
 *   <li>Test builder with minimal required fields
 *   <li>Test builder with partial field combinations
 *   <li>Test lifecycle callbacks (@PrePersist, @PreUpdate)
 *   <li>Test all ProductCategory enum values
 *   <li>Test boolean active flag variations
 * </ul>
 *
 * <p><strong>Target:</strong> Achieve 100% instruction and branch coverage for
...
class ProductBuilderTest {
     ...
     *
     * <p><strong>Scenario:</strong> Construct Product entity with complete data.
     *
     * <p><strong>Given:</strong> All Product fields have values.
     *
     * <p><strong>When:</strong> Builder builds Product instance.
     *
     * <p><strong>Then:</strong> Product contains all specified field values.
     *
     * <p><strong>Coverage:</strong> Tests all Product builder setter methods.
     */
    @Test
    ...
    void shouldBuildProductWithAllFields() {
        ...
        assertThat(product.getDescription())
                .isEqualTo("High-performance laptop with 16GB RAM and 512GB SSD");
     ...
     *
     * <p><strong>Scenario:</strong> Construct Product with only mandatory fields.
     *
     * <p><strong>Given:</strong> Only name, price, stockQuantity, sku, category provided.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product has required fields, optionals are null.
     *
     ...
     *
     * <p><strong>Scenario:</strong> Build electronic product.
     *
     * <p><strong>Given:</strong> Category=ELECTRONICS.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product has ELECTRONICS category.
     *
     * <p><strong>Coverage:</strong> Tests category builder with ELECTRONICS enum.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build clothing product.
     *
     * <p><strong>Given:</strong> Category=CLOTHING.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product has CLOTHING category.
     *
     * <p><strong>Coverage:</strong> Tests category builder with CLOTHING enum.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build book product.
     *
     * <p><strong>Given:</strong> Category=BOOKS.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product has BOOKS category.
     *
     * <p><strong>Coverage:</strong> Tests category builder with BOOKS enum.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build home goods product.
     *
     * <p><strong>Given:</strong> Category=HOME.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product has HOME_GARDEN category.
     *
     * <p><strong>Coverage:</strong> Tests category builder with HOME_GARDEN enum.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build sports equipment product.
     *
     * <p><strong>Given:</strong> Category=SPORTS.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product has SPORTS category.
     *
     * <p><strong>Coverage:</strong> Tests category builder with SPORTS enum.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build active product.
     *
     * <p><strong>Given:</strong> Active=true.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product is active.
     *
     * <p><strong>Coverage:</strong> Tests active builder method with true.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build inactive product.
     *
     * <p><strong>Given:</strong> Active=false.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product is inactive.
     *
     * <p><strong>Coverage:</strong> Tests active builder method with false.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build product with detailed description.
     *
     * <p><strong>Given:</strong> Description text provided.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product has specified description.
     *
     * <p><strong>Coverage:</strong> Tests description builder method.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build products with different inventory levels.
     *
     * <p><strong>Given:</strong> Various stockQuantity values.
     *
     * <p><strong>When:</strong> Builder builds Products.
     *
     * <p><strong>Then:</strong> Products have specified stock quantities.
     *
     * <p><strong>Coverage:</strong> Tests stockQuantity builder method.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build products with different price values.
     *
     * <p><strong>Given:</strong> Various price BigDecimal values.
     *
     * <p><strong>When:</strong> Builder builds Products.
     *
     * <p><strong>Then:</strong> Products have specified prices.
     *
     * <p><strong>Coverage:</strong> Tests price builder method with various decimals.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Build product with explicit timestamps.
     *
     * <p><strong>Given:</strong> CreatedAt and updatedAt timestamps provided.
     *
     * <p><strong>When:</strong> Builder builds Product.
     *
     * <p><strong>Then:</strong> Product has specified timestamps.
     *
     * <p><strong>Coverage:</strong> Tests timestamp builder methods.
     */
    @Test
     ...
     *
     * <p><strong>Given:</strong> Product built without active flag and timestamps.
     *
     * <p><strong>When:</strong> onCreate() is called manually (simulates JPA).
     *
     * <p><strong>Then:</strong> Default values are set (active=true, timestamps=now).
     *
     ...
     *
     * <p><strong>Scenario:</strong> JPA callback updates timestamp before update.
     *
     * <p><strong>Given:</strong> Product with old updatedAt timestamp.
     *
     * <p><strong>When:</strong> onUpdate() is called manually (simulates JPA).
     *
     * <p><strong>Then:</strong> UpdatedAt timestamp is refreshed to current time.
     *
