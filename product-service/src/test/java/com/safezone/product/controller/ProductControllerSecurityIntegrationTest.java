...
class ProductControllerSecurityIntegrationTest {
                ...
                .andExpect(
                        result -> {
                            ...
                            org.assertj.core.api.Assertions.assertThat(status)
                                    .as(
                                            "GET /api/v1/products/1 should be public and return 200 or 404 if not found")
                                    .isIn(200, 404);
                        });
    }
    ...
    void getAllProducts_requiresAuth() throws Exception {
        mockMvc.perform(get("/api/v1/products")).andExpect(status().isOk()); // Public endpoint
    }
    ...
    void deleteProduct_requiresAuth() throws Exception {
        mockMvc.perform(delete("/api/v1/products/1")).andExpect(status().isUnauthorized());
    }
}
