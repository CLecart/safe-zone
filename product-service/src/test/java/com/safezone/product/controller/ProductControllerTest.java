...
/**
 * Integration tests for {@link ProductController}. Tests REST endpoints with MockMvc and mocked
 * service layer.
 *
...
class ProductControllerTest {
    ...
    void shouldGetProductsWithPagination() throws Exception {
        ...
        Page<ProductResponse> productPage =
                new PageImpl<>(Objects.requireNonNull(responseList), PageRequest.of(0, 20), 1);
    ...
    void shouldValidateCreateProductRequest() throws Exception {
        CreateProductRequest invalidRequest =
                new CreateProductRequest("", null, BigDecimal.valueOf(-1), -10, "", null);
