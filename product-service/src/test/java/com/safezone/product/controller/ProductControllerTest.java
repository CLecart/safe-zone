...
/**
 * Integration tests for {@link ProductController}. Tests REST endpoints with
 * MockMvc and mocked
 * service layer.
 *
...
class ProductControllerTest {
        ...
        void shouldGetProductsWithPagination() throws Exception {
                ...
                Page<ProductResponse> productPage = new PageImpl<>(Objects.requireNonNull(responseList),
        ...
        void shouldUpdateProduct() throws Exception {
                UpdateProductRequest updateRequest = new UpdateProductRequest(
                                "Updated Product", null, BigDecimal.valueOf(149.99), null, null, null);
        ...
        void shouldUpdateStockWithInventoryRole() throws Exception {
                ...
                mockMvc.perform(patch("/api/v1/products/1/stock").param("quantity", "50"))
                                .andDo(print())
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$.success").value(true));
        }
        ...
        void shouldCheckProductAvailability() throws Exception {
                ...
                mockMvc.perform(get("/api/v1/products/1/availability").param("quantity", "10"))
                                .andDo(print())
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$.success").value(true))
        ...
        void shouldValidateCreateProductRequest() throws Exception {
                CreateProductRequest invalidRequest = new CreateProductRequest("", null, BigDecimal.valueOf(-1), -10,
                                "", null);
        ...
        void shouldGetActiveProducts() throws Exception {
                ...
                mockMvc.perform(get("/api/v1/products/active").param("page", "0").param("size", "20"))
                                .andDo(print())
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$.success").value(true))
                                .andExpect(jsonPath("$.data.totalElements").value(1));
