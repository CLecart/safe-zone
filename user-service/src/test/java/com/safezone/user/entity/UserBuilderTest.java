 ...
 *
 * <p><strong>Purpose:</strong> Tests the Lombok-generated builder for User entity to achieve 100%
 * code coverage. Builder pattern allows flexible object construction with optional fields.
 *
 * <p><strong>Coverage Strategy:</strong>
 *
 * <ul>
 *   <li>Test builder with all fields populated
 *   <li>Test builder with minimal fields (ID, username, email, password)
 *   <li>Test builder with partial fields (combinations)
 *   <li>Test default values (@Builder.Default for roles)
 *   <li>Test lifecycle callbacks (@PrePersist, @PreUpdate)
 *   <li>Test business methods (addRole, removeRole, getFullName)
 * </ul>
 *
 * <p><strong>Target:</strong> Achieve 100% instruction and branch coverage for User.UserBuilder.
 *
...
class UserBuilderTest {
     ...
     *
     * <p><strong>Scenario:</strong> Construct User entity using builder pattern with all fields.
     *
     * <p><strong>Given:</strong> All User fields have values.
     *
     * <p><strong>When:</strong> Builder builds User instance.
     *
     * <p><strong>Then:</strong> User instance contains all specified field values.
     *
     * <p><strong>Coverage:</strong> Tests all builder setter methods and build() method.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Construct User with only mandatory fields.
     *
     * <p><strong>Given:</strong> Only ID, username, email, password are provided.
     *
     * <p><strong>When:</strong> Builder builds User instance.
     *
     * <p><strong>Then:</strong> User instance has required fields set, optional fields are null.
     *
     * <p><strong>Coverage:</strong> Tests builder with partial field population.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Builder with explicitly set roles.
     *
     * <p><strong>Given:</strong> Roles set contains ADMIN and SUPPORT.
     *
     * <p><strong>When:</strong> Builder builds User.
     *
     * <p><strong>Then:</strong> User has specified roles.
     *
     * <p><strong>Coverage:</strong> Tests roles collection builder method.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Builder with account status flags.
     *
     * <p><strong>Given:</strong> Enabled=false, Locked=true.
     *
     * <p><strong>When:</strong> Builder builds User.
     *
     * <p><strong>Then:</strong> User has specified status flags.
     *
     * <p><strong>Coverage:</strong> Tests boolean flag builder methods.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Builder with firstName and lastName.
     *
     * <p><strong>Given:</strong> FirstName="John", LastName="Doe".
     *
     * <p><strong>When:</strong> Builder builds User.
     *
     * <p><strong>Then:</strong> User has specified names.
     *
     * <p><strong>Coverage:</strong> Tests firstName and lastName builder methods.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Builder with phone number.
     *
     * <p><strong>Given:</strong> Phone="+33123456789".
     *
     * <p><strong>When:</strong> Builder builds User.
     *
     * <p><strong>Then:</strong> User has specified phone.
     *
     * <p><strong>Coverage:</strong> Tests phone builder method.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Builder with createdAt, updatedAt, lastLoginAt.
     *
     * <p><strong>Given:</strong> Timestamp values for all date fields.
     *
     * <p><strong>When:</strong> Builder builds User.
     *
     * <p><strong>Then:</strong> User has specified timestamps.
     *
     ...
     *
     * <p><strong>Given:</strong> User built without enabled/locked/timestamps.
     *
     * <p><strong>When:</strong> onCreate() is called manually (simulates JPA).
     *
     * <p><strong>Then:</strong> Default values are set (enabled=true, locked=false,
     * timestamps=now).
     *
     ...
     *
     * <p><strong>Given:</strong> User with old updatedAt timestamp.
     *
     ...
     *
     * <p><strong>Scenario:</strong> Add ADMIN role to user with USER role.
     *
     * <p><strong>Given:</strong> User has USER role.
     *
     * <p><strong>When:</strong> addRole(ADMIN) is called.
     *
     * <p><strong>Then:</strong> User has both USER and ADMIN roles.
     *
     * <p><strong>Coverage:</strong> Tests addRole() method.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> Remove ADMIN role from user with multiple roles.
     *
     * <p><strong>Given:</strong> User has USER and ADMIN roles.
     *
     * <p><strong>When:</strong> removeRole(ADMIN) is called.
     *
     * <p><strong>Then:</strong> User has only USER role remaining.
     *
     * <p><strong>Coverage:</strong> Tests removeRole() method.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> User has complete name.
     *
     * <p><strong>Given:</strong> FirstName="John", LastName="Doe".
     *
     * <p><strong>When:</strong> getFullName() is called.
     *
     * <p><strong>Then:</strong> Returns "John Doe".
     *
     * <p><strong>Coverage:</strong> Tests getFullName() happy path.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> User has only first name.
     *
     * <p><strong>Given:</strong> FirstName="John", LastName=null.
     *
     * <p><strong>When:</strong> getFullName() is called.
     *
     * <p><strong>Then:</strong> Returns "John".
     *
     * <p><strong>Coverage:</strong> Tests getFullName() with partial name.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> User has only last name.
     *
     * <p><strong>Given:</strong> FirstName=null, LastName="Doe".
     *
     * <p><strong>When:</strong> getFullName() is called.
     *
     * <p><strong>Then:</strong> Returns "Doe".
     *
     * <p><strong>Coverage:</strong> Tests getFullName() with partial name.
     */
    @Test
     ...
     *
     * <p><strong>Scenario:</strong> User has no name fields.
     *
     * <p><strong>Given:</strong> FirstName=null, LastName=null, Username="johndoe".
     *
     * <p><strong>When:</strong> getFullName() is called.
     *
     * <p><strong>Then:</strong> Returns username as fallback "johndoe".
     *
     * <p><strong>Coverage:</strong> Tests getFullName() fallback logic.
     */
    @Test
