 ...
 *
 * <p>Contains all required and optional fields for creating a new user account. Validates username
 * format, email, password strength, and phone format.
 *
 * @param username the unique username (3-50 alphanumeric characters or underscores)
